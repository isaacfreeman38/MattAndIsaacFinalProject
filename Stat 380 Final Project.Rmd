...
We used the same technique as above but this time we compared the median income in 2014 for all 50 states and their Happiness rating to see if there was a correlation between the 2. The is a positive correlation with an r value of .608.
```{r}
GatheredIncome2014 <-
  GatheredIncome %>%
    filter(year == "2014") %>%
